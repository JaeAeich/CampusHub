...
export const products: Product[] = [
  ...
  },
  {
    product_id: 'product3',
    offer_id: 'offer3',
    product_categories: ['Food', 'Snacks'],
    product_description: 'Crunchy potato chips with a tangy flavor.',
    product_images: ['/products/chips.jpg'],
  ...
  },
  {
    ...
    offer_id: 'offer4',
    product_categories: ['Food', 'Beverages'],
    product_description: 'Refreshing lemonade with a hint of mint.',
    product_images: ['/products/lemonade.png'],
  ...
  },
  {
    ...
    offer_id: 'offer5',
    product_categories: ['Food', 'Beverages'],
    product_description: 'A refreshing fruit juice blend with a tropical twist.',
    product_images: ['/products/fruit-juice.png'],
