...
import addUser from '@/api/users/users';
  ...
  function CreateAccount() {
    ...
    const [userDetails, setUserDetails] = useState({
      ...
      user_gender: '',
      order_ids: [],
      user_image: "https://www.nicepng.com/png/full/933-9332131_profile-picture-default-png.png", 
      user_address: '',
      cart_id: '',
      wishlist_cart_id: ''
    });
    ...
    const handleSubmit =()=>{
      ...
      setMandatory(false);
        setTryAgain(false);
      const addedUser = addUser(userDetails);
          ...
          <div className="grid max-w-2xl mx-auto mt-8">
            ...
            <div className="items-center mt-8 sm:mt-14 text-primary">
              <div className="flex flex-col items-center w-full mb-2 space-x-0 space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0 sm:mb-6">
                ...
                <label htmlFor="name" className="block mb-2 text-smm font-medium text-primary dark:text-background">
                    Name
                  </label>
                  <input
                    type="text"
              ...
              <label htmlFor="email" className="block mb-2 text-smm font-medium text-primary dark:text-background">
                Email
              </label>
              <input
                type="email"
              ...
              <div className="mb-2 sm:mb-6">
              <label htmlFor="phoneNumber" className="block mb-2 text-smm font-medium text-primary dark:text-background">
                Phone Number
              </label>
              <input
                type="tel"
              ...
              <select
                id="gender"
                className="bg-background border darkgray text-primary text-smm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                onChange={(e) => handleChange('user_gender', e.target.value)}
              >
              ...
              <div className="mb-6">
              <label htmlFor="address" className="block mb-2 text-smm font-medium text-primary dark:text-background">
                  Address
                </label>
                <textarea
                  id="address"
              ...
              <div className="flex flex-col">
                ...
                {fieldLeft&&<p className='pt-3 font-semibold flex mx-auto text-accent text-smm'>All fields are mandatory!</p>}
                {tryAgain&&<p className='pt-3 font-semibold flex mx-auto text-accent text-smm'>Try Again!</p>}
              </div>
            </div>
          </div>
        </div>
