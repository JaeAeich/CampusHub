...
export default function ServiceCards() {
  ...
  return (
    <Container>
      <h2 className="font-heading xl:text-2xl sm:text-xl text-lg font-semibold sm:my-4 mt-10 sm: mb-2">Services </h2>
      <div className="mb-10">
        <Carousel
          opts={{
            align: 'start',
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="relative group">
                  <Card>
                    <h1 className="p-4 xl:text-xl md:text-lg sm:text-md font-subheading font-semibold">{service.name}</h1>
