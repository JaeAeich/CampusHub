...
export default function ProductPage() {
  ...
  const [current, setCurrent] = useState(product.product_images[0]);
  return (
    <div className="py-10 mx-auto sm:w-7xl max-w-full">
      <div className="mx-auto px-4">
        <div className="flex flex-col lg:flex-row sm:mx-4 mx-2">
          <div className="w-full lg:flex-1 lg:mx-10">
            <div className="lg:h-[460px] md:h-[400px] h-[300px] sm:w-[600px] w-full rounded-lg overflow-hidden mx-auto">
            ...
            <Carousel className="my-10">
              <CarouselContent>
                {product.product_images.map((image: string, index: number) => (
                  <CarouselItem
                    className="lg:w-16 lg:h-32 h-28 sm:basis-1/3 basis-1/2"
          ...
          <div className="flex flex-col h-full px-4 lg:justify-left sm:justify-center sm:items-center justify-left">
