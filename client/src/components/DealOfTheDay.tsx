                  ...
                  <div className="flex flex-col justify-center px-16">
                    ...
                    <div className="flex-col justify-left">
                      ...
                      <div className="flex items-center">
                        <p className="font-helvetica text-neutral-500 text-lg font-bold mr-3">
                          Time left
                        </p>
                        <Badge variant="secondary" className="mr-2 px-3 py-2">
                          12
                        </Badge>
                        :
                        <Badge variant="secondary" className="mx-2 px-3 py-2">
                          16
                        </Badge>
                        :
                        <Badge variant="secondary" className="mx-2 px-3 py-2">
